...
const Header = () => {
    return (
        <div className='flex justify-between w-full px-8 py-3 border-b border-[#D9D9D9] bg-white'>
            <div className='flex items-center gap-4'>
                <h2 className='text-[#1A181E] '>Payments</h2>
                <div className='flex items-center gap-1.5 cursor-pointer'>
                    <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 14 14" fill="none">
                        <g clip-path="url(#clip0_382_2522)">
            ...
            <div className='max-w-[400px] w-full flex items-center bg-[#F2F2F2] rounded-md gap-2 px-4 py-2.5'>
                ...
                <input type="text" placeholder='Search features, tutorials, etc.' className='bg-transparent w-full border-0 outline-none' />
            </div>

            <div className='flex gap-3'>
                <h4 className='w-10 h-10 grid place-content-center bg-[#E6E6E6] rounded-full cursor-pointer'>
                ...
                <h4 className='w-10 h-10 grid place-content-center bg-[#E6E6E6] rounded-full cursor-pointer'>
                    <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 40 40" fill="none">
                        <g clip-path="url(#clip0_382_2537)">
